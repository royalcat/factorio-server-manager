        ...
        <Panel
            ...
            content={
                <>
                    ...
                    <p className="mb-4">Please use the <a className="text-blue hover:text-blue-light" target="_blank" href="https://github.com/royalcat/factorio-server-manager/issues">GitHub repository</a> to report bugs or seek for help.</p>
